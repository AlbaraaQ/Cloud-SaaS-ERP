...
export class InventoryController {
  ...
  @Get('transfers') @RequiresPermission('inventory.view') listTransfers(@Query('status') status?: string) { return this.inventory.listTransfers(getTenantContext().tenantId, status); }
