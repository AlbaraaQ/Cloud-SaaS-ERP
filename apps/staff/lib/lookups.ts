...
export type Warehouse = { id: string; code?: string; name?: string; nameAr?: string; name_ar?: string; branchId?: string; branch_id?: string; isDefault?: boolean; is_default?: boolean };
export type Item = {
  id: string;
  sku: string;
  barcode?: string | null;
  ...
  max_discount_amt?: string | null;
  trackLot?: boolean;
  track_lot?: boolean;
  trackSerial?: boolean;
  track_serial?: boolean;
  weightedScale?: boolean;
  weighted_scale?: boolean;
  showInPos?: boolean;
  show_in_pos?: boolean;
};
