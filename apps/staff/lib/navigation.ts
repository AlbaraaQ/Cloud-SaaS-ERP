  ...
  groups: [
    {
      ...
      items: [
        ...
        screen('payment-methods', 'طرق الدفع', 'Payment methods', '/accounting/payment-methods', 'ready', { permission: 'parties.view', endpoint: '/payment-methods' }),
    ...
    },
    {
      ...
      items: [
        ...
        screen('trial-balance', 'ميزان المراجعة', 'Trial balance', '/accounting/trial-balance', 'ready', { permission: 'accounting.reports.view', endpoint: '/statements/trial-balance' }),
  ...
  groups: [
    {
      ...
      labelEn: 'Definitions',
      items: [
        screen('items', 'دليل المواد وبطاقاتها', 'Item directory and cards', '/inventory/items', 'ready', { permission: 'catalog.item.view', endpoint: '/organization/catalog/items' }),
    ...
    },
    {
      ...
      items: [
        ...
        screen('opening-stock', 'بضاعة أول المدة', 'Opening stock', '/inventory/opening-stock', 'ready', { permission: 'inventory.adjust', endpoint: '/inventory/documents?kind=opening' }),
        screen('goods-in', 'فاتورة إدخال', 'Goods receipt', '/inventory/receipts', 'ready', { permission: 'inventory.adjust', endpoint: '/inventory/documents?kind=receipt' }),
        screen('goods-out', 'فاتورة إخراج', 'Goods issue', '/inventory/issues', 'ready', { permission: 'inventory.adjust', endpoint: '/inventory/documents?kind=issue' }),
        screen('stock-adjust', 'تسوية وجرد مخزني', 'Stock adjustment', '/inventory/adjustments', 'ready', { permission: 'inventory.adjust', endpoint: '/inventory/documents?kind=adjustment' }),
  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        ...
        screen('sales-invoice-profit', 'أرباح الفواتير', 'Invoice profit', '/reports/invoice-profit', 'ready', { permission: 'reporting.view', endpoint: 'GET /reports/invoice-profit' }),
  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        ...
        screen('payroll-run', 'إستحقاق وصرف الرواتب', 'Payroll run and payment', '/hrm/payroll', 'ready', { endpoint: '/hrm/payroll/runs' }),
      ],
    },
    {
      key: 'hrm-reports',
      ...
      items: [
        ...
        screen('user-logs', 'سجلات المستخدمين', 'User logs', '/settings/audit', 'ready', { permission: 'tenant.audit.view', endpoint: '/audit-log' }),
      ],
    },
  ],
};
  ...
  groups: [
    {
      ...
      labelEn: 'Definitions',
      items: [
        screen('marina-vessel', 'بطاقات النماذج والمراكب والملاك', 'Model, vessel and owner cards', '/marina/vessels', 'ready', { endpoint: '/marina' }),
      ],
    },
    {
      key: 'marina-manage',
    ...
    },
    {
      ...
      items: [
        ...
        screen('marina-bookings', 'الحجوزات والإضافات والفواتير', 'Bookings, additions and invoices', '/marina/bookings', 'ready', { endpoint: '/marina/bookings' }),
  ...
  groups: [
    {
      ...
      labelEn: 'Definitions',
      items: [
        screen('boq-item', 'بطاقة بند', 'BOQ item card', '/s/projects/boq', 'api', { permission: 'projects.manage', endpoint: 'POST /projects/{id}/boq' }),
        screen('project-stages', 'مراحل مشروع', 'Project stages', '/s/projects/stages', 'api', { permission: 'projects.manage', endpoint: 'POST /projects/{id}/stages' }),
      ],
    },
    {
      key: 'projects-ops',
      ...
      items: [
        ...
        screen('contractor-contract', 'عقد مقاول', 'Contractor contract', '/projects/contractor-contract', 'ready', { permission: 'projects.manage', endpoint: '/contracting/contracts' }),
        screen('project-followup', 'متابعة', 'Follow-up', '/projects/followup', 'ready', { permission: 'projects.view', endpoint: '/projects/{id}' }),
        screen('project-offers', 'عروض', 'Offers', '/projects/offers', 'ready', { permission: 'projects.manage', endpoint: '/contracting/offers' }),
        screen('contractor-payment', 'سند دفع لمقاول', 'Contractor payment', '/projects/contractor-payment', 'ready', { permission: 'projects.contractor.pay', endpoint: 'POST /contracting/contracts/{id}/payments' }),
      ],
    },
  ],
};
  ...
  groups: [
    {
      ...
      items: [
        screen('company-card', 'بطاقة المنشأة', 'Company card', '/settings/company', 'ready', { permission: 'tenant.profile.view', endpoint: '/company-profile' }),
    ...
    },
    {
      ...
      items: [
        screen('backup', 'النسخ الإحتياطي', 'Backup', '/settings/backup', 'ready', { permission: 'settings.backup.manage', endpoint: '/settings/backups' }),
        screen('data-rotation', 'تدوير البيانات', 'Data rotation', '/settings/data-rotation', 'ready', { permission: 'settings.rotation.manage', endpoint: '/settings/data-rotation' }),
        screen('new-file', 'إنشاء ملف', 'New company file', '/settings/new-file', 'ready', { permission: 'settings.companyfile.create', endpoint: '/settings/company-files' }),
        ...
        screen('invoice-maintenance', 'صيانة الفواتير', 'Invoice maintenance', '/settings/invoice-maintenance', 'ready', { permission: 'settings.maintenance.manage', endpoint: '/settings/invoice-maintenance' }),
        ...
        screen('restore', 'إستعادة البيانات', 'Restore', '/settings/restore', 'ready', { permission: 'settings.restore.manage', endpoint: '/settings/restores' }),
      ],
    },
    {
      key: 'settings-users',
      ...
      labelEn: 'Users',
      items: [
        screen('user-card', 'بطاقة مستخدم', 'User card', '/settings/users', 'ready', { permission: 'tenant.users.manage', endpoint: '/memberships' }),
        screen('user-permissions', 'صلاحيات المستخدمين', 'User permissions', '/settings/roles', 'ready', { permission: 'tenant.roles.manage', endpoint: '/roles' }),
    ...
    },
    {
      ...
      labelEn: 'General',
      items: [
        screen('general-settings', 'إعدادات عامة', 'General settings', '/settings/general', 'ready', { permission: 'tenant.settings.manage', endpoint: '/settings' }),
  ...
  groups: [
    {
      ...
      items: [
        ...
        screen('report-designer', 'فتح المصمم لتصميم التقارير', 'Report designer', '/support/report-designer', 'ready', { permission: 'reporting.layout.manage', endpoint: '/reports/layouts' }),
