...
- `app/` — 12 pages: `overview` (`/`), `tenants`, `tenants/new`, `subscriptions`, `plans`,
  `activation-requests`, `users`, `roles`, `audit`, `health`, `jobs`, `settings`.
...
- `tests/` — navigation + route/kit coverage checks (12 tests).
