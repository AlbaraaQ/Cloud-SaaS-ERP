...
describe('admin navigation coverage', () => {
  it('covers dashboard plus master requirement sections 1-12', () => {
    expect(sections.map((section) => section.key)).toEqual(['dashboard','platform','organization','catalog','accounting','parties','inventory','sales','purchases','treasury','einvoicing','reporting','migration','pos']);
  });
