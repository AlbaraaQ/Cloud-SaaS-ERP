...
**الحالة: الأجزاء الأول والثاني والثالث والرابع والخامس والسادس والسابع مُنجزة** — الجزء الأول 🧑‍💼 المندوبون
...
بقية الوحدات — سلة — مبدؤها في خارطة
الطريق (`ROADMAP_PHASES_02_11.md`) وقياسها في §11.
...
12. **🖨️ طباعة** مؤجَّلة مع `Reports/*.repx` (§12).
...
* **`Additions` كجدول تعاريف** (الأسماء وأسعارها التي يقرأ منها `cmbAdditions`) — الإضافة
  تُكتب بوصفها وكميتها وسعرها في بطاقة الحجز، وتعاريفها لم تُبنَ مع `frmGroupM` في الجزء
  السابع لأن النافذة لا تُديرها (`cmbAdditions` يقرأ الجدول ولا نافذةَ له)؛ فهي مؤجَّلة
  إلى جزءٍ يبني تعاريف المرسى كلها.
