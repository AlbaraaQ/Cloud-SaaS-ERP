...
| 09 | Verticals (contracting/projects, salesmen & commissions, marina, optics, tailoring, orders, Salla) | 🟡 **part 1 done** — 🧑‍💼 المندوبون والعمولات: بطاقة المندوب بالثلاث نسب (`comm` · `Colle_Comm` · `Profit_Comm`) + «📋 طباعة فواتير مندوب وعمولاتهم» (ترحيل 0052 يضيف النسب والاتصالات وجسر `employee_id` بين بطاقة المندوب وبطاقة الموظف؛ `GET /sales/salesmen/commissions` يقرأ الفواتير وإشعارات المدين وسندات القبض؛ 14 tests + 21 live checks) | `PHASE_09_VERTICALS.md` §1–§4 |
