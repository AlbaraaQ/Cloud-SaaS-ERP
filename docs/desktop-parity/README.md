...
| 05 | Inventory (vouchers, transfers, counts, serials/lots, reorder, multi-unit, barcodes, expiry, **in-transit, item card**) | ✅ done (parts 1–4, incl. the UI pass) | `PHASE_05_INVENTORY.md` §8 |
