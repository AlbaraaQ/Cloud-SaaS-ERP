...
| 08 | HRM (بطاقة الموظف، الإدارات والأقسام، الوظائف، الحوافز والجزاءات، دفع الرواتب، كشف حساب موظف، تقرير الرواتب) | 🟡 **part 4 done** — 👤 بطاقة الموظف + 🏢 الإدارات/الأقسام + 💼 الوظائف (0049) · 🎁 الحوافز والجزاءات (0050) · 💵 دفع الرواتب (0051) · 📄 كشف حساب موظف (بلا ترحيل: `GET /hrm/employee-statement` يقرأ كشف الحساب القائم على حساب الموظف — «اختر موظف»، «الرصيد السابق»، تجميعي/تفصيلي، والبطاقات الأربع بعبارة `UpdateSummary`؛ والصفّ الذي كان يشير إلى `/reports/employee-account` صار «كشف حساب موظف» على `/hrm/employee-statement`، وتصحيحٌ لخصم السلفة المصروفة مرتين؛ 50 tests + 82 live checks) | `PHASE_08_HRM.md` §1–§7 |
