...
| 05 | Inventory (vouchers, transfers, counts, serials/lots, reorder, multi-unit, barcodes, expiry, **in-transit, item card**) | ✅ done (parts 1–3) · part four (UI pass) planned | `PHASE_05_INVENTORY.md` §8 |
