...
| 08 | HRM (بطاقة الموظف، الإدارات والأقسام، الوظائف، الحوافز والجزاءات، دفع الرواتب، كشف حساب موظف، تقرير الرواتب) | 🟡 **part 3 done** — 👤 بطاقة الموظف + 🏢 الإدارات/الأقسام + 💼 الوظائف (0049) · 🎁 الحوافز والجزاءات (0050) · 💵 دفع الرواتب (0051: جدول `salary_payments` — إذن صرف لكل موظف عن كل شهر، «رقم الإذن» و«لقد تم دفع راتب الموظف سابقاً» والرفوض الثلاثة بعبارة الديسكتوب، الصافي من مسيّر الشهر، سند صرف مرحَّل لكل إذن، وحذفٌ يرفض المرحَّل؛ 39 tests + 64 live checks) | `PHASE_08_HRM.md` §1–§6 |
