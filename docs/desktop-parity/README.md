...
| 08 | HRM (بطاقة الموظف، الإدارات والأقسام، الوظائف، الحوافز والجزاءات، دفع الرواتب، كشف حساب موظف، تقرير الرواتب) | 🟡 **part 2 done** — 👤 بطاقة الموظف + 🏢 الإدارات/الأقسام + 💼 الوظائف (ترحيل 0049) و🎁 الحوافز والجزاءات كاملة (ترحيل 0050: `salary_adjustment_types` + `رقم السند`/`نوع الإجراء`/`طريقة الدفع` على `salary_adjustments`، الأنواع الثلاثة مزروعة لكل مستأجر، الرفوض الأربعة بعبارة الديسكتوب، الملاحظة التي تُكتب نفسها، قيدٌ لكل حركة تُصرف الآن، وحذفٌ ناعم يرفض المرحَّل وما دخل مسيراً؛ 27 tests + 45 live checks) | `PHASE_08_HRM.md` §1–§5 |
