...
| 07 | Accounting (دليل الحسابات والشجرة بالأرصدة، كشف الحساب، إنشاء قيد يومية، مراكز التكلفة، الفترات والميزان) | 🟡 **part 1 done** — 📂 دليل الحسابات بالأرصدة + بطاقة الحساب (migration 0045, 8 tests, live `verify-accounting.mjs`); parts 2–5 surveyed | `PHASE_07_ACCOUNTING.md` §1–§6 |
