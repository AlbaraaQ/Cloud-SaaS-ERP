...
| 06 | Treasury (سند القبض والصرف بوثيقة كاملة + القيد، **تعريف الخزن والبنوك**، حركة الصندوق، **إغلاقات اليومية**، **التحويل البنكي والعميل النقدي**، **مناقلة الخزن**) | 🟡 parts 1–6 done (`سند القبض وسند الصرف`، `تعريف الخزن والبنوك`، `حركة الصندوق`، `إغلاقات اليومية`، `التحويل البنكي والعميل النقدي`، `مناقلة الخزن`) | `PHASE_06_TREASURY.md` §1–§14 · `NEXT_SESSION_PROMPT_AFTER_PHASE_06.md` |
