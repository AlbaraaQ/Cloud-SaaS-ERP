...
| 08 | HRM (بطاقة الموظف، الإدارات والأقسام، الوظائف، الحوافز والجزاءات، دفع الرواتب، كشف حساب موظف، تقرير الرواتب) | 🟡 **part 1 done** — 👤 بطاقة الموظف كاملة (كل حقول `frmEmployees` + 🏢 الإدارات/الأقسام بمستويين + 💼 الوظائف، ترحيل 0049: `رقم الحساب` حسابٌ باسم الموظف تحت 2241، وإجمالي الرواتب والمستحقات، ورفوض الحذف الثلاثة بعبارة الديسكتوب؛ 16 tests + 27 live checks) | `PHASE_08_HRM.md` §1–§4 |
