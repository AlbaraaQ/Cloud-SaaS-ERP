...
| 06 | Treasury (سند القبض والصرف بوثيقة كاملة + القيد، **تعريف الخزن والبنوك**، حركة الصندوق، إغلاقات اليومية، تحويل بنكي، مناقلة الخزن) | 🟡 parts 1–2 done (`سند القبض وسند الصرف`، `تعريف الخزن والبنوك`); parts 3–6 planned | `PHASE_06_TREASURY.md` §1–§9 · `NEXT_SESSION_PROMPT_AFTER_PHASE_06.md` |
