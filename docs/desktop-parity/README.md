...
| 07 | Accounting (دليل الحسابات والشجرة بالأرصدة، كشف الحساب، إنشاء قيد يومية، مراكز التكلفة، الفترات والميزان) | 🟡 **parts 1–2 done** — 📂 دليل الحسابات بالأرصدة + بطاقة الحساب (migration 0045) · 📄 كشف الحساب بالرصيد السابق والمتحرّك وتجميعي/تفصيلي وكشف حساب رئيسي (12 tests + 37 live checks); parts 3–5 surveyed | `PHASE_07_ACCOUNTING.md` §1–§6 |
