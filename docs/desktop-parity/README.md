...
| 07 | Accounting (دليل الحسابات والشجرة بالأرصدة، كشف الحساب، إنشاء قيد يومية، مراكز التكلفة، الفترات والميزان) | 🟡 **parts 1–4 done** — 📂 دليل الحسابات بالأرصدة + بطاقة الحساب (0045) · 📄 كشف الحساب بالرصيد السابق والمتحرّك وتجميعي/تفصيلي وكشف حساب رئيسي · 📒 إنشاء قيد يومية بـ⏰ الوقت و✅ قيد ضريبي والمندوب والفرق= (0046) · 🌳 مراكز التكلفة: شجرة بالأرصدة + 📊 كشف مركز الكلفة، و0047 يُصلح إبطال القيود (34 tests + 60 live checks); part 5 surveyed | `PHASE_07_ACCOUNTING.md` §1–§6 |
