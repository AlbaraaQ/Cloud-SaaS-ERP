...
| 06 | Treasury (**سند القبض والصرف بوثيقة كاملة + القيد**، تعريف الخزن والبنوك، حركة الصندوق، إغلاقات اليومية، تحويل بنكي، مناقلة الخزن) | 🟡 part 1 done (`سند القبض وسند الصرف`); parts 2–6 planned | `PHASE_06_TREASURY.md` §1–§8 · `NEXT_SESSION_PROMPT_AFTER_PHASE_06.md` |
