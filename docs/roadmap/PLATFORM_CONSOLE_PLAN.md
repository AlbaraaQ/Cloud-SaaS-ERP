...
**المجموع المقدَّر:** ≈ 128 اختباراً و≈ 360 نقطة تحقّق حيّة (المتبقّي بعد P-C1+P-C2+P-C3+P-C4:
≈ 52 اختباراً و≈ 50 نقطة، ورقم `verify` التراكمي صار **307** نقطة في **29** قسماً: 160/17
من `verify-platform-console.mjs` و147/12 من `verify-platform-billing.mjs`).
