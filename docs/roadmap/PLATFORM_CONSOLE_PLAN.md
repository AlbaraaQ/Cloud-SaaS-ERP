...
كلها. ويبقى **مؤجَّلاً صراحةً**: المستأجر التجريبي (sandbox) الذي ذكرته الخطّة في شاشات P-C11 بلا
نقاط نهاية · والتقرير الأسبوعي بالبريد من P-C12 (يحتاج قالباً من P-C6 ومجدولاً في العامل) ·
وأفواج الإيراد وتصدير Excel/PDF.
