...
> | PHASE_08 | 2026-09-06 | IN_PROGRESS | Party and subledger foundation: tenant-scoped parties, contacts, payment allocations, credit-limit checks, balance/statement routes, reversible migration `0005_parties.sql`, and RLS. Full invoice/payment-voucher contract coverage and database-backed concurrency tests remain pending. See `PHASE_08_IMPLEMENTATION_REPORT.md`. | |
